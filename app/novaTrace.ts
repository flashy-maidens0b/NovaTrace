...
export default function NovaTrace() {
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 860, margin: "44px auto", fontFamily: "system-ui" }}>
        <h1>NovaTrace — Built for Base</h1>
        ...
        <Connected>
          <input
            placeholder="Paste address to read ETH balance"
            value={address}
